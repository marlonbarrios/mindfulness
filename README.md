...
- Explore how **prompt creation and guided dialogue** can become **embodied practices** for cultivating awareness and emotional regulation.  
- Develop **AI systems as technologies of the self**, capable of supporting **ethical attention**, **somatic reflection**, and **cognitive reframing**.  
- Propose **AI-mediated contemplative practices** as extensions of **psychotherapy, somatic education, and mindfulness training**.  
- Formulate a **decolonial framework** for mind–body technologies that acknowledges the historical and epistemic asymmetries embedded in computation and spirituality.  
...
- **Prototype development** of Sati-AI (using generative language and image models).  
- **Dialogical testing sessions** with practitioners and researchers.  
- **Embodied and somatic experiments** involving guided mindfulness practices mediated by AI systems.  
- **Autoethnographic writing and reflection**, documenting the affective and cognitive effects of human–machine interaction.  
- **Critical contextualization** through philosophy, decolonial theory, and Buddhist epistemology.  
